...
class C_retrieve():
    ...
    def retrieve_context(self, question, value, k=15):
...
# BM25 is not working properly or i dont know how to make it work, so i use only FAISS
        value.L_semantic_search=[value.records[i].text for i in I[0]]
        return [value.records[i].text for i in I[0]]